...
bool ListLabel::Initialize()
{
  ...
  label = "V+jets";
  Insert("ZToLL10-50-0Jet_sm-no_masses",label);
  Insert("ZToLL10-50-1Jet_sm-no_masses",label);
  Insert("ZToLL10-50-2Jet_sm-no_masses",label);
  Insert("ZToLL10-50-3Jet_sm-no_masses",label);

  Insert("ZToLL50-0Jet_sm-no_masses",label);
  Insert("ZToLL50-1Jet_sm-no_masses",label);
  Insert("ZToLL50-2Jet_sm-no_masses",label);
  Insert("ZToLL50-3Jet_sm-no_masses",label);
  Insert("ZToLL50-4Jet_sm-no_masses",label);

  label = "V+jets";
  Insert("ZToNuNu-0Jet_sm-no_masses",label);
  Insert("ZToNuNu-1Jet_sm-no_masses",label);
  Insert("ZToNuNu-2Jet_sm-no_masses",label);
  Insert("ZToNuNu-3Jet_sm-no_masses",label);

  label = "V+jets";
  Insert("WToLNu-0Jet_sm-no_masses",label);
  Insert("WToLNu-1Jet_sm-no_masses",label);
  Insert("WToLNu-2Jet_sm-no_masses",label);
  Insert("WToLNu-3Jet_sm-no_masses",label);
  Insert("WToLNu-4Jets_sm-no_masses",label); 
  ...
  label="Signal hct";
  Insert("TTtoLHtoGammaGamma-kappa-hct",label);
  label="Signal hut";
  Insert("TTtoLHtoGammaGamma-kappa-hut",label);

  label="AA+jets";
  Insert("AA-1Jet_sm-no_masses",label);
  Insert("AA-2Jets_sm-no_masses",label);
  Insert("AA-3Jets_sm-no_masses",label);
