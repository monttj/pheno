...
namespace MA5
{
  ...
  public:
    ...
    double TrackIsolationObservable(const RecPhotonFormat* part, ConeType cone) const; 
    ...
    bool isTrackIsolated(const RecPhotonFormat* part, const double& threshold, ConeType cone) const
    {
      double isolation = TrackIsolationObservable(part,cone);
      if (isolation<0) return false;
      else return ( isolation < threshold );
    }
    bool isTrackIsolated(const RecPhotonFormat& part, double threshold, ConeType cone) const
    { return isTrackIsolated(&part,threshold,cone); }
    ...
    double CalorimeterIsolationObservable(const RecPhotonFormat* part, ConeType cone) const;
    ...
    bool isCalorimeterIsolated(const RecPhotonFormat* part, const double& threshold, ConeType cone) const
    {
      double isolation = CalorimeterIsolationObservable(part,cone);
      if (isolation<0) return false;
      else return ( isolation < threshold );
    ...
    bool isCalorimeterIsolated(const RecPhotonFormat& part, double threshold, ConeType cone) const
    { return isCalorimeterIsolated(&part,threshold,cone); }
    ...
    double PFlowIsolationObservable(const RecPhotonFormat* part, ConeType cone) const;
    ...
    bool isPFlowIsolated(const RecPhotonFormat* part, const double& threshold, ConeType cone) const
    {
      double isolation = PFlowIsolationObservable(part,cone);
      if (isolation<0) return false;
      else return ( isolation < threshold );
    }
    bool isPFlowIsolated(const RecPhotonFormat& part, double threshold, ConeType cone) const
    { return isPFlowIsolated(&part,threshold,cone); }
    ...
    double CombinedIsolationObservable(const RecPhotonFormat* part, ConeType cone) const;
    bool passCombinedIsolation(const RecPhotonFormat* part, const double& threshold, ConeType cone) const
    {
      double isolation = CombinedIsolationObservable(part,cone);
      if (isolation<0) return false;
      else return ( isolation < threshold );
    }
    bool passCombinedIsolation(const RecPhotonFormat& part, double threshold, ConeType cone) const
    { return passCombinedIsolation(&part,threshold,cone); }
    ...
    // Fake Electrons
    // -----------------------------------------------------------------------------
    bool isFakeElectron(const RecJetFormat* jet);
    std::vector<const RecLeptonFormat*> FakeElectrons(std::vector<const RecJetFormat*>& jets, bool removeJets, double PTmin = 10, double ETAmax = 2.5);
    std::vector<const RecLeptonFormat*> FakeElectrons(const EventFormat& event, double PTmin = 10, double ETAmax = 2.5);
    void FakeElectrons(const EventFormat& event, std::vector<const RecLeptonFormat*>& leptons, double PTmin = 10, double ETAmax = 2.5);
    // -----------------------------------------------------------------------------
    // Sorting method
    // -----------------------------------------------------------------------------
    static bool SortLeptonPt(const RecLeptonFormat* lep1, const RecLeptonFormat* lep2);//{ return (lep1->pt()<lep2->pt()); }
